...
import { Menu, X, ChevronRight, Star, Users, Award, Clock, Shield, Code, Rocket, Search, FileText, Phone, Mail, MapPin, Globe, CheckCircle, ArrowRight, Play, DollarSign, Zap, Heart, Target, TrendingUp, BookOpen, GraduationCap, Building, School, Palette, Settings, Laptop, Headphones, Database, Smartphone, PenTool, Trophy, Users2, Calendar, MessageCircle, Briefcase, Eye, Lightbulb, Building2, HeadphonesIcon } from 'lucide-react';
