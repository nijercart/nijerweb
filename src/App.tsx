...
function App() {
  ...
  const translations = {
    en: {
      ...
      // Services
      servicesTitle: "Enterprise Educational Technology Solutions",
      servicesDescription: "We deliver enterprise-grade, scalable digital platforms specifically engineered for educational institutions. Our solutions feature advanced architecture, comprehensive functionality, and seamless integration capabilities.",
      primarySchools: "Primary Schools",
      primaryDesc: "Comprehensive digital platforms featuring integrated student information systems, academic management portals, and advanced parent-teacher communication infrastructure.",
      kindergarten: "Kindergarten",
      kindergartenDesc: "Secure, child-centric platforms with interactive educational features, virtual campus environments, and real-time communication systems for parents and administrators.",
      highSchools: "High Schools",
      highSchoolsDesc: "Advanced academic management systems with digital certification, integrated learning management, and comprehensive student information portals.",
      colleges: "Colleges",
      collegesDesc: "Enterprise-level institutional platforms with virtual campus infrastructure, comprehensive course management, and integrated career development services.",
      madrasas: "Madrasas",
      madrasasDesc: "Specialized platforms for Islamic educational institutions with integrated academic tools, religious scheduling systems, and community engagement infrastructure.",
